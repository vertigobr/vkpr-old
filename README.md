...
**This project is obsolete and has been replaced by the [VKPR CLI](https://github.com/vertigobr/vkpr-cli)**

VKPR was inspired in Bitnami's [BKPR project](https://github.com/bitnami/kube-prod-runtime) but it was handed over through an aggregation of Helm subcharts. The amount of subcharts made that approach unfeasible, so we moved to a brand new CLI.
